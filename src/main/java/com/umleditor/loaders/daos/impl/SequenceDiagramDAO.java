...
import com.umleditor.sequencediagram.interfaces.UMLSequenceDiagram;

import java.io.*;

public class SequenceDiagramDAO implements DiagramDAO {
    @Override
    ...
    public boolean saveDiagram(UMLDiagram diagram, String fileName) {
        if (diagram instanceof UMLSequenceDiagram) {
            ...
            throw new IllegalArgumentException("Wrong UMLDiagram type was given instead of UMLSequenceDiagram: " + diagram.getClass().getName());
        }
    }
}
